    ...
    public class BaseDBConfig
    {
        ...
        private static string InitConn()
        {
            ...
            else if (isMySqlEnabled)
            {
                ...
                return "Server=localhost; Port=3306;Stmt=; Database=blog; Uid=root; Pwd=yesyes;";//DifDBConnOfSecurity(@"D:\my-file\dbCountPsw1_MySqlConn.txt", @"c:\my-file\dbCountPsw1_MySqlConn.txt", mySqlConnection);
            }
